...
### Client-side database[​](https://www.greatfrontend.com/questions/system-design/chat-application-messenger#client-side-database "Direct link to Client-side database")
...
#### Receiving real-time updates[​](https://www.greatfrontend.com/questions/system-design/chat-application-messenger#receiving-real-time-updates "Direct link to Receiving real-time updates")
...
### Client-only state[​](https://www.greatfrontend.com/questions/system-design/chat-application-messenger#client-only-state "Direct link to Client-only state")
...
### Offline support[​](https://www.greatfrontend.com/questions/system-design/chat-application-messenger#offline-support "Direct link to Offline support")
...
### User experience[​](https://www.greatfrontend.com/questions/system-design/chat-application-messenger#user-experience "Direct link to User experience")

#### Maintaining scroll position[​](https://www.greatfrontend.com/questions/system-design/chat-application-messenger#maintaining-scroll-position "Direct link to Maintaining scroll position")
...
#### Other possible improvements[​](https://www.greatfrontend.com/questions/system-design/chat-application-messenger#other-possible-improvements "Direct link to Other possible improvements")

- Add a "Scroll to Bottom" button that's visible when the user has scrolled upwards within the conversation messages.

### Gradient effect[​](https://www.greatfrontend.com/questions/system-design/chat-application-messenger#gradient-effect "Direct link to Gradient effect")
